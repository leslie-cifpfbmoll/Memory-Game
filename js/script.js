...
function mostrar(cartasnivel) {
    ...
    document.getElementById('partida').innerHTML = carta;
        ...
        if (img_select.length == 0) {
            ...
            if ((img_select[0] == img_select[1]) && (img_select[0] == img_select[2]) && (img_select[2] == img_select[1])) {
                ...
                function Back() {
                    ...
                    carta3.style.pointerEvents = "auto";
                    carta1.style.background = 'rgb(255, 255, 255)';
                    carta2.style.background = 'rgb(255, 255, 255)';
                    carta3.style.background = 'rgb(255, 255, 255)';
